...
## ✨ News
- [April, 2026] The official data release approval is still undergoing. Researchers interested in early access to the full dataset may apply via our **[Dataset Access Request Form](https://docs.google.com/forms/d/e/1FAIpQLSfpnJ-FBUlsP0Hd5Yx-YnKDffd8n-QZMA-xBc-lAPyfdQiCmw/viewform?usp=dialog)**. Please note that early access is currently limited to research use only. Requests will be reviewed and coordinated with ManyCore Inc. on a case-by-case basis.
